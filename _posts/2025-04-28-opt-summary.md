...
| FS $L$-IS C             | Optimality gap        | $\Omega \left( n + D \sqrt{n L \epsilon^{-1}} \right)$         | $\checkmark$          | <d-cite key="woodworth2016tight"></d-cite>, Theorem 7          | <d-cite key="allen2018katyusha"></d-cite>, Corollary 3.7 |
